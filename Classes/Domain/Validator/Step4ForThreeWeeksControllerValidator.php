...
class Step4ForThreeWeeksControllerValidator extends AbstractStepsControllerValidator
{
    /**
    ...
    public function isValid($newForgotPill)
    {
        ...
        if (empty($newForgotPill->getDidYouTakeThePillCorrectlyInPreviousWeeks())) {
